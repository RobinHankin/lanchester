...
\node[text=blue] at (-2.75, 4.0) {$(1,4)$};
\node[text=blue] at ( 0.0 , 4.8) {$(3,3)$};
\node[text=blue] at ( 2.75, 4.0) {$(4,1)$};
...
\node[text=blue] at (-1.75, 7.0) {$(3,5)$};
\node[text=blue] at ( 1.75, 7.0) {$(5,3)$};
\node[text=blue] at (-1   , 7.8) {$(4,5)$};
\node[text=blue] at ( 1   , 7.8) {$(5,4)$};
\node[text=blue] at ( 0.0 , 8.8) {$(5,5)$};

\node[text=red ] at (-2   , 7.2) {$\frac{27}{280}$};
\node[text=red ] at ( 0   , 7.2) {\half};
\node[text=red ] at ( 2   , 7.2) {$\frac{253}{280}$};
\node[text=red ] at (-1   , 8.2) {$\frac{139}{504}$};
\node[text=red ] at ( 1   , 8.2) {$\frac{365}{504}$};

\node[text=red ] at (-3   , 6.2) {$0$};
\node[text=red ] at ( 0   , 9.2) {\half};
\node[text=red ] at ( 3   , 6.2) {$1$};
