...
$\left|a-b\right|\geqslant 2$; figure~\ref{nnp1}.  We may set up a
recurrence relation as per figure~\ref{nnp1rec} and conclude that
...
cat("\\input{nnp2.tex}")
@
\caption{Precautionary surrender\label{nnp2_rec}}
\end{figure}
