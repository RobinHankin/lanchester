...
Therecurrence relation from figure~\ref{nnp2_cell} is $x_{n+1} =
\frac{1}{2}\cdot\frac{n}{2n+1} + y\cdot\frac{n+1}{2n+1}$ with $y =
x_n\cdot\frac{n-1}{2n} + 1\cdot\frac{n+1}{2n}$, or altogether
