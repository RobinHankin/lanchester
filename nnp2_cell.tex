...
\node[text=red ] at ( 0.6   , 0.1) {$x_{n-1}=p(n,n-1)$};
\node[text=red ] at (-1   , 1.1) {$\frac{1}{2}$};
\node[text=red ] at ( 0   , 2.1) {$x_{n+1}=p(n+1,n)$};
\node[text=red ] at ( 1.5 , 1.1) {$y=p(n+1,n-1)$};
\node[text=red ] at ( 2   , 0.2) {$1$};

\node[text=blue] at ( 0  , -0.15) {$(n,n-1)$};
\node[text=blue] at ( 2  , -0.15) {$(n+2,n-2)$};
\node[text=blue] at ( 0  ,  1.6 ) {$(n+1,n)$};
