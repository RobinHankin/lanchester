...
$\frac{n+1}{n-1/2}\ft(1,-n;\frac{3}{2}-n;\frac{1}{4})$.  Note that AMS-15.4.13, viz
...
to get $\Gamma(2+n)\Gamma(1/2-n)\sqrt{3/\pi}$.  Now we have
$\Gamma(1/2-n) =
\frac{(-4)^n\sqrt{\pi}}{2}\cdot\frac{\Gamma(n)}{\Gamma(2n)}$; and also
we know that $\Gamma(2n)/\Gamma(n)^2={2n\choose n\,\,n}/(2n-1)$ so
overall the second term becomes
$\frac{(\sqrt{3}/2)n(n+1)(2n-1)(-4)^n}{2n\choose n\,\,n}$.
