...
we know that $\Gamma(2n)/\Gamma(n)^2=(2n-1){2n\choose n\,\,n}$, so
$\Gamma(1/2-n)=\frac{(-4)^n\sqrt{\pi}}{2(2n-1){2n\choose n\,\,n}}$.
So overall the second term becomes


$$-i\frac{\sqrt{3}}{4}\cdot\frac{\Gamma(n+2)}{(2n-1){2n\choose n\,\,n}}$$
...
-i\frac{\sqrt{3}}{4}\cdot\frac{\Gamma(n+1)}{(2n-1){2n\choose n\,\,n}}
$$
