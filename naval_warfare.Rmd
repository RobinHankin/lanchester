...
%  probs for horizontal lines:
\node at (0.5, 0.85)  {$\frac{1}{2}$};
\node at (1.5, 0.85)  {$\frac{1}{3}$};
\node at (2.5, 0.85)  {$\frac{1}{4}$};
\node at (3.5, 0.85)  {$\frac{1}{5}$};

\node at (0.5, 1.85)  {$\frac{2}{3}$};
\node at (1.5, 1.85)  {$\frac{2}{4}$};
\node at (2.5, 1.85)  {$\frac{2}{5}$};
\node at (3.5, 1.85)  {$\frac{2}{6}$};

\node at (0.5, 2.85)  {$\frac{3}{4}$};
\node at (1.5, 2.85)  {$\frac{3}{5}$};
\node at (2.5, 2.85)  {$\frac{3}{6}$};
\node at (3.5, 2.85)  {$\frac{3}{7}$};


%  probs for vertical lines:
\node at (0.85, 0.5)  {$\frac{1}{2}$};
\node at (1.85, 0.5)  {$\frac{2}{3}$};
\node at (2.85, 0.5)  {$\frac{3}{4}$};
\node at (3.85, 0.5)  {$\frac{4}{5}$};

\node at (0.85, 1.5)  {$\frac{1}{3}$};
\node at (1.85, 1.5)  {$\frac{2}{4}$};
\node at (2.85, 1.5)  {$\frac{3}{5}$};
\node at (3.85, 1.5)  {$\frac{4}{6}$};

\node at (0.85, 2.5)  {$\frac{1}{4}$};
\node at (1.85, 2.5)  {$\frac{2}{5}$};
\node at (2.85, 2.5)  {$\frac{3}{6}$};
\node at (3.85, 2.5)  {$\frac{4}{7}$};
...
\fill ( 1,0) circle[radius=6pt]; \node[text=red] at ( 1.1, 0.1)  {$1$};
\fill (-1,0) circle[radius=6pt]; \node[text=red] at (-1.1, 0.1)  {$0$};
\node at (-0.5, 0.7) {\half};
\node at ( 0.5, 0.7) {\half};
...
\draw[line width=0.5mm] ( 0,3) -- (-1,2) node[sloped, pos=0.5, allow upside down]{\arrowIn}; ;
\fill (-2,1) circle[radius=6pt]; \node[text=red] at (-2.1, 1.1)  {$0$};
\fill ( 2,1) circle[radius=6pt]; \node[text=red] at ( 2.1, 1.1)  {$1$};
\fill (-1,2) circle[radius=2pt];
\fill ( 1,2) circle[radius=2pt];
...
\draw[line width=0.5mm] ( 0,5) -- (-1,4) node[sloped, pos=0.5, allow upside down]{\arrowIn}; ;
\fill (-2,3) circle[radius=6pt]; \node[text=red] at (-2.1, 3.1)  {$0$};
\fill ( 2,3) circle[radius=6pt]; \node[text=red] at ( 2.1, 3.1)  {$1$};
...
\node            at (-1.5 , 3.7) {TBC};
\node            at ( 1.5 , 3.7) {TBC};
\node[text=blue] at (-1.75, 3.0) {$(0,2)$};
\node[text=blue] at ( 1.75, 3.0) {$(2,0)$};
\node[text=blue] at (-1   , 3.8) {$(1,2)$};
\node[text=blue] at ( 1   , 3.8) {$(2,1)$};
\node            at (-0.5 , 4.7) {\half};
\node            at ( 0.5 , 4.7) {\half};
\node[text=blue] at ( 0.0 , 4.8) {$(2,2)$};
...
\draw[line width=0.5mm] ( 0,7) -- (-1,6) node[sloped, pos=0.5, allow upside down]{\arrowIn}; ;
\fill (-2,5) circle[radius=6pt]; \node[text=red] at (-2.1, 5.1)  {$0$};
\fill ( 2,5) circle[radius=6pt]; \node[text=red] at ( 2.1, 5.1)  {$1$};
...
\node            at (-1.5 , 5.7) {TBC};
\node            at ( 1.5 , 5.7) {TBC};
\node[text=blue] at (-1.75, 5.0) {$(0,2)$};
\node[text=blue] at ( 1.75, 5.0) {$(2,0)$};
\node[text=blue] at (-1   , 5.8) {$(1,2)$};
\node[text=blue] at ( 1   , 5.8) {$(2,1)$};
\node            at (-0.5 , 6.7) {\half};
\node            at ( 0.5 , 6.7) {\half};
\node[text=blue] at ( 0.0 , 6.8) {$(2,2)$};
